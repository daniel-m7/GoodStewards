...
class BamlSyncClient:
    ...
    def ExtractReceiptData(self, receipt: baml_py.Image,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractReceiptData", args={
            "receipt": receipt,
        })
...
class BamlStreamClient:
    ...
    def ExtractReceiptData(self, receipt: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ReceiptData, types.ReceiptData]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractReceiptData", args={
            "receipt": receipt,
        })
        return baml_py.BamlSyncStream[stream_types.ReceiptData, types.ReceiptData](
          result,
...
class BamlHttpRequestClient:
    ...
    def ExtractReceiptData(self, receipt: baml_py.Image,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractReceiptData", args={
            "receipt": receipt,
        }, mode="request")
        return result
