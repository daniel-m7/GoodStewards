...
class ReceiptDataAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: typing.Set[str] = set([  "vendor_name",  "purchase_date",  "county",  "subtotal_amount",  "tax_amount",  "total_amount",  "expense_category",  "is_donation",  "tax_breakdowns",  ])
...
class ReceiptDataProperties:
    ...
    @property
    def is_donation(self) -> type_builder.ClassPropertyViewer:
        return type_builder.ClassPropertyViewer(self.__bldr.property("is_donation"))
...
class TaxBreakdownAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: typing.Set[str] = set([  "tax_type",  "tax_rate",  "amount",  ])
...
class TaxBreakdownProperties:
    ...
    @property
    def tax_rate(self) -> type_builder.ClassPropertyViewer:
        return type_builder.ClassPropertyViewer(self.__bldr.property("tax_rate"))
